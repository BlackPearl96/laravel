                    ...
                    <div class="col-sm-6">
                        <div class="your-order">
                                    ...
                                    <div class="your-order-item">
                                        <div>
                                            ...
                                            @foreach($product_cart as $product)
                                                <div class="media">
                                                    <img width="25%"
                                                         src="client/image/product/{{$product['item']['image_featured']}}"
                                                         alt="" class="pull-left">
                                ...
                                <ul class="payment_methods methods">
                                    <li class="payment_method_bacs">
                                        ...
                                        <div class="payment_box payment_method_bacs" style="display: block;">
                                            ...
                                            bạn xem hàng rồi thanh toán tiền cho nhân viên giao hàng
                                        </div>
                                    </li>
                                    ...
                                    <li class="payment_method_cheque">
                                        ...
                                        <div class="payment_box payment_method_cheque" style="display: none;">
                                            ...
                                            <br>- Số tài khoản: 01287464271
                                            <br>- Chủ TK: Nguyễn Văn Lực
                                            <br>- Ngân hàng AGRIBANK, Chi nhánh TP.Đà Nẵng
                                        </div>
                                    </li>
                            ...
                            <div class="text-center">
                                <button class="beta-btn primary" type="submit"onclick="myFunction()" href="#">Đặt hàng <i
